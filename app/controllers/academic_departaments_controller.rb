class AcademicDepartamentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @academic_departament.save
        format.html { redirect_to @academic_departament, notice: 'Academic departament was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @academic_departament.update(academic_departament_params)
        format.html { redirect_to @academic_departament, notice: 'Academic departament was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to academic_departaments_url, notice: 'Academic departament was successfully destroyed.' }
